...
This is the manuscript for the paper _Packaging research artifacts with RO-Crate_.

For now it is edited as a hybrid of [Manubot]() and [Overleaf]() using Markdown in the [content](content)/ folder.
