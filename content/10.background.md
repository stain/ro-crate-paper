...
The rest of this paper is organised as follows. We first describe RO-Crate, the assumptions underlying it, and define RO-Crate technically and formally. We then proceed to introduce the community (section \ref{}) and tooling (section \ref{tooling}). We move to analyse RO-Crate with respect to usage in a diverse set of domains (section \ref{inuse}). Finally, we present related work and conclude with some remarks including RO-Crate highlights and future work. 