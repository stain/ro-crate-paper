...
\begin{table}[htbp]
	...
	\begin{tabular}{llll}
        ...
        \textbf{SCHeMa} \citep{athenarc-schema} & Workflow users & PHP & Alpha \\
        \multicolumn{4}{l}{\it Workflow execution using RO-Crate as exchange mechanism \citep{doi:10.5281/zenodo.4671709} } \\
